...
export namespace Live2DCubismFramework {
  ...
  export class CubismRenderer_WebGL extends CubismRenderer {
     ...
     * モデルを描画する実際の処理
     */
    public doDrawModel(opacity:number,bright:number): void {
      ...
      for (let i = 0; i < drawableCount; ++i) {
        ...
        this.drawMesh(
          ...
          this.getModel().getDrawableOpacity(drawableIndex)*opacity,
    ...
    public drawMesh(
      ...
      if (this.getClippingContextBufferForMask() == null) {
        ...
        if (this.isPremultipliedAlpha()) {
          modelColorRGBA.R *= modelColorRGBA.A*bright;
          modelColorRGBA.G *= modelColorRGBA.A*bright;
          modelColorRGBA.B *= modelColorRGBA.A*bright;
        }
      }
